...
| `sdd-po` | When the SDD orchestrator needs to create, read, or update Jira tickets during the SDD lifecycle. Also generates PO-level test cases. | [`skills/sdd-po/SKILL.md`](skills/sdd-po/SKILL.md) |
